...
if need be, applies the migrations, generates the client, and starts the
admin panel beside the database.
...
bun run init        # .env from .env.example, Postgres container, migrations, admin panel (scripts/init.ts)
